...
async function initializeDatabase() {
  ...
  `);
    ...
    try {
        await exports.sqlite.execute(`ALTER TABLE clients ADD COLUMN address TEXT DEFAULT '';`);
    }
    catch { }
    try {
        await exports.sqlite.execute(`ALTER TABLE clients ADD COLUMN manager_phone TEXT DEFAULT '';`);
    }
    catch { }
    try {

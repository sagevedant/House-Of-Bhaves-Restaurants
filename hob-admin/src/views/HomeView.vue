<template>
  <AppLayout
    ...
    subtitle="Multi-Tenant WhatsApp Booking Engine internal operator console"
    action-label="New Tenant"
    @action="handleCreateTenant"
  >
    <!-- Template Actions Override (Demonstrating button-primary + button-ghost) -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="rounded-[40px] bg-gradient-to-br from-[#ec48bd] via-[#b32b8a] to-[#5865f2] p-6 text-[#ffffff] shadow-[0_3px_68px_rgba(236,72,189,0.22)] flex flex-col justify-between">
        ...
        <div class="my-4">
          <div class="text-[36px] font-[700] font-display leading-[1.1]">$18,450</div>
          <div class="text-[12px] text-[#ffffff]/90 font-[500] mt-1">+14.2% active tier subscriptions</div>
        </div>
        <div class="text-[11px] text-[#ffffff]/70 font-mono border-t border-[#ffffff]/20 pt-2">
          32 Active Restaurant Tenants
        </div>
      </div>
      ...
      <div class="rounded-[16px] bg-[#1e2353] border border-[#23272a] p-5 flex flex-col justify-between">
        ...
        <div class="my-3">
          ...
          <div class="text-[12px] text-[#00b0f4] font-[500] mt-0.5 font-mono">
            78% auto-confirmed by AI
          </div>
        </div>
        <div class="text-[11px] text-[#ffffff]/40 border-t border-[#23272a] pt-2">
          Average party size: 3.4 guests
        </div>
      </div>
    ...
    <!-- Main Content Panel: Active Restaurant Tenants Data Table -->
    <div class="rounded-[16px] bg-[#1e2353] border border-[#23272a] overflow-hidden">
      ...
      <div class="p-5 border-b border-[#23272a] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-[13px] text-[#ffffff]/60 mt-0.5">
            Real-time status of multi-tenant WhatsApp booking engines
          </p>
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <!-- Filter button -->
          <button class="px-3 py-1.5 rounded-[12px] bg-[#0a0d3a] hover:bg-[#23272a] text-[#ffffff] text-[14px] font-[500] border border-[#23272a] flex items-center gap-1.5 transition-colors duration-120 cursor-pointer">
      ...
      <!-- Dense Data Table (rounded.sm / no zebra striping) -->
        ...
        <table class="w-full text-left border-collapse font-sans">
          <thead>
            <tr class="bg-[#0a0d3a]/60 border-b border-[#23272a] text-[13px] font-[600] uppercase tracking-wider text-[#ffffff]/70">
              <th class="py-3 px-5">Restaurant Tenant</th>
              <th class="py-3 px-5">Phone ID</th>
              <th class="py-3 px-5">Engine Status</th>
              <th class="py-3 px-5">Today's Bookings</th>
              <th class="py-3 px-5">API Quota</th>
          ...
          <tbody class="divide-y divide-[#23272a] text-[14px]">
            ...
            <tr class="hover:bg-[#0a0d3a]/40 transition-colors duration-120">
              <td class="py-3 px-5">
                <div class="font-[600] text-[#ffffff] text-[15px]">Spice Factory Rooftop &amp; Lounge</div>
                <div class="text-[12px] text-[#00b0f4] font-mono">tenant_sf_rooftop_01</div>
              </td>
              ...
              <td class="py-3 px-5 font-mono text-[#35ed7e] text-[13px]">
                32% used
              </td>
              <td class="py-3 px-5 text-right">
                <div class="inline-flex items-center justify-end gap-2">
                  <button class="px-2.5 py-1 rounded-[6px] bg-[#0a0d3a] hover:bg-[#5865f2] text-[#ffffff] text-[12px] font-[500] border border-[#23272a] transition-colors duration-120 cursor-pointer">
                    Console
                  </button>
            ...
            <tr class="hover:bg-[#0a0d3a]/40 transition-colors duration-120">
              <td class="py-3 px-5">
                <div class="font-[600] text-[#ffffff] text-[15px]">The Bombay Courtyard Kitchen</div>
                <div class="text-[12px] text-[#00b0f4] font-mono">tenant_bc_mumbai_02</div>
              </td>
              <td class="py-3 px-5 font-mono text-[#ffffff]/80">
                +91 91234 56789
              </td>
              ...
              <td class="py-3 px-5 font-mono text-[#00b0f4] text-[13px]">
                89% used
              </td>
              <td class="py-3 px-5 text-right">
                <div class="inline-flex items-center justify-end gap-2">
            ...
            <tr class="hover:bg-[#0a0d3a]/40 transition-colors duration-120">
              <td class="py-3 px-5">
                <div class="font-[600] text-[#ffffff]/60 text-[15px]">Heritage Bistro Old Town</div>
                <div class="text-[12px] text-[#ffffff]/40 font-mono">tenant_hb_delhi_09</div>
              </td>
              ...
              <td class="py-3 px-5 font-mono text-[#ffffff]/40 text-[13px]">
                0%
              </td>
              <td class="py-3 px-5 text-right">
                <div class="inline-flex items-center justify-end gap-2">
...
function handleCreateTenant() {
  console.log('Provision tenant clicked')
}
</script>
